...
# With potential modifications by Trang Tran

import sys
import pstree, render_tree, init, treebanks, parse_errors
import head_finder, tree_transform
...
def read_tree(text, out_dict, label):
	...
	complete_tree = treebanks.ptb_read_tree(fake_file, allow_empty_labels=True,	allow_empty_words=False)
